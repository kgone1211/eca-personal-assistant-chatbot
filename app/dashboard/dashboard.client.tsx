                ...
                <div>
                  ...
                  {project.clientName && (
                    <div className="form-group">
                      ...
                      <p>{project.clientName} {project.clientEmail && `(${project.clientEmail})`}</p>
                    </div>
                  )}
                  ...
                  <div className="form-group">
                    ...
                    {project.endDate && <p>Ends: {new Date(project.endDate).toLocaleDateString()}</p>}
                  </div>
                  
                  {/* Milestones */}
                  <div className="form-group">
                    <label className="form-label">Milestones ({project.milestones.length})</label>
                  ...
                  {/* Transcripts */}
                  <div className="form-group">
                    <label className="form-label">Call Transcripts ({project.transcripts.length})</label>
                    <div className="transcripts-list">
                      {project.transcripts.map(transcript => (
                        <div key={transcript.id} className="transcript-item">
                          ...
                          {transcript.duration && <p>Duration: {transcript.duration} minutes</p>}
                          {transcript.participants && <p>Participants: {transcript.participants}</p>}
                          {transcript.analysis && (
                            <div className="transcript-analysis">
                              <p><strong>Summary:</strong> {transcript.analysis.summary}</p>
                              <p><strong>Sentiment:</strong> {transcript.analysis.sentiment}</p>
                            </div>
                          )}
                        </div>
                      ))}
                  ...
                  {/* Insights */}
                  <div className="form-group">
                    <label className="form-label">AI Insights ({project.insights.length})</label>
